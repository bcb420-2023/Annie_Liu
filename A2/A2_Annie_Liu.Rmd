...
AS_heatmap_matrix_tophits <- scale(heatmap_matrix_diff[which(rownames(heatmap_matrix_diff)  %in% AS_top_hits,)])
...
AR_heatmap_matrix_tophits <-scale(heatmap_matrix_diff[which(rownames(heatmap_matrix_diff)  %in% AR_top_hits,)])
