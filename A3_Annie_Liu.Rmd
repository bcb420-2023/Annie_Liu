...
# write.table(AS_output, "./projects/ASvsall_ranked_list.rnk", row.names = FALSE, quote = FALSE, sep="\t")
            

```


**What method did you use? What genesets did you use? Make sure to specify versions and cite your methods. Summarize your enrichment results.**
