...
There are 457 nodes and 2026 edges in this map under a moderately conservation threshold of p-value < 0.005 and FDR < 0.075. 
...
![Fig 2: Publication Ready Figure](./AS_to_ALL_annotated.png)
...
![Figure 3: Summary Network](./AS_to_All- Summary Network.png)
Innate immune response associated themes and other immune system related themes were present in this analysis which is to be expected in the analysis of an asthma related gene set. There was quite a large and dense node labeled "vpu mediated degradation" which has been novel.
